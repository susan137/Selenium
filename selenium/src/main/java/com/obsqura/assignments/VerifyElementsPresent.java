...
import org.testng.annotations.AfterMethod;
	...
	public class VerifyElementsPresent  {
		...
		@Test
		void verifyTextboxMenuElements() throws InterruptedException {
		...
		void verifyWebtableMenu() {
			...
			List<WebElement> oddrows=driver.findElements(By.xpath("//div[@class='rt-tr -odd']"));
			
			List<WebElement> oddeven=driver.findElements(By.xpath("//div[@class='rt-tr -even']"));
			
			int count=oddrows.size()+oddeven.size();
			System.out.println("The rows with data: "+count);
